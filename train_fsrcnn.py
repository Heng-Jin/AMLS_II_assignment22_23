...
model_save_path = parent_path / ("FSRCNN_train_test_" + str(time.strftime("%m_%d_%H_%M", time.localtime())))
...
def run():
    '''
    main fucntion of train FSRCNN, including Residual-FSRCNN as well
    Returns:   nothing
